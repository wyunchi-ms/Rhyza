...
Call archify_render with the JSON specification. The tool validates and renders it, writes a reproducible .mjs script, the validated .json specification, a full self-contained .html page, and a compact .preview.html derived from that full page in the session workspace.
...
export default function archifyExtension(pi: ExtensionAPI): void {
	...
	pi.registerTool({
		...
		description:
			"Validate an Archify JSON specification and generate full HTML, its compact chat preview, JSON source, and replay script. Returns a generic html-preview reference for the final answer.",
